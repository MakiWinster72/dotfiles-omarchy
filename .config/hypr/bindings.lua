...
-- SUPER + SHIFT + N 原功能：打开默认编辑器。
-- SUPER + ALT + S 原功能：将窗口移动到 Scratchpad。
hl.unbind("SUPER + T")
hl.unbind("SUPER + E")
hl.unbind("SUPER + O")
hl.unbind("SUPER + W")
...
o.bind("SUPER + SHIFT + T", "Obsidian Daily Todo", "omarchy-shell shell toggle luca.obsidian-daily")
o.bind("SUPER + Q", "Close window", hl.dsp.window.close())
o.bind("SUPER + B", "Browser", { omarchy = "browser" })
o.bind("SUPER + E", "文件模糊搜索", "omarchy-shell shell toggle sgruendel.fzf")
o.bind("SUPER + SHIFT + E", "Everything", "omarchy-shell shell toggle b.everything")
...
o.bind("mouse:276", "最大化窗口", hl.dsp.window.fullscreen({ mode = "maximized" }))
o.bind("mouse:275", "工作区总览", "omarchy-shell shell toggle mirador '{}'")
o.bind("SUPER + mouse:276", "切换到上一个工作区", hl.dsp.focus({ workspace = "e-1" }))
o.bind("SUPER + mouse:275", "切换到下一个工作区", hl.dsp.focus({ workspace = "e+1" }))
...
o.bind("SUPER + ALT + H", "打开 Herdr 面板", "omarchy-shell shell toggle jankeesvw.herdr")
o.bind("SUPER + SHIFT + O", "恢复 AI 会话", "omarchy-shell shell toggle anagrius.resume")
